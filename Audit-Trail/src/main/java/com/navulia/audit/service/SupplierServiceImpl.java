...
public class SupplierServiceImpl implements  SupplierService{
    ...
    //Constructor Injection  --- Most Preferable then @Autowired
    ...
    public SupplierOutputDTO updateSupplier(long id, SupplierInputDTO supplierDto) {
        ...
        Supplier supplier = Supplier.builder()
                ...
                .contactDetails(supplierDto.getContactDetails())
                .address(supplierDto.getAddress())
                .specialties(supplierDto.getSpecialties())
                .id(existingSupplier.getId())
                .createdBy(existingSupplier.getCreatedBy())
                .createdDate(existingSupplier.getCreatedDate())
                .build();
        return supplierRepository.save(supplier).viewAsOutputDto();
    }
}
