package com.navulia.audit.configuration;
...
public class BasicSecurityConfiguration {
    ...
    public UserDetailsService userDetailsService() {
        ...
        UserDetails supplier = User.builder().username("supplier").password(passwordEncoder().encode("password")).roles("SUPPLIER").build();
